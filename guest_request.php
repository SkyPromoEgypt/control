...
<script type="text/javascript" src="_js/requests.js"></script>
...
<div id="wrraper">
  <div id="systeminbox" class="tabDiv">
    <h1>Guest Requests</h1>
    <p>Below is a list of your rooms, click on a room to view its guest request. Use the form to below</p>
    <p>to add, edit or delete the requests.</p>
    <p>&nbsp;</p>
    <div id="roomsView"></div>
    <div class="requestBG" id="reminderView">
    <table id="tblReminder">
    <tr><td align="left" valign="top"><div id="reminderDetails"></div></td></tr>
    </table>
    <table width="349" id="tblReminderControl">
    <tr><td><table width="341">
    <tr><td width="52" align="left" valign="top"><label for="remDate">Date</label></td><td width="224"><input type="text" id="remDate" name="remDate" /></td>
      <td width="49" id="grRoomNumber">&nbsp;</td>
    </tr>
    <tr><td align="left" valign="top"><label for="remText">Request</label></td><td colspan="2"><textarea id="remText" name="remText"></textarea></td></tr>
    <tr><td align="left" valign="top"></td><td colspan="2"><input type="button" id="addRem" name="addRem" value="Add Reminder" /><input type="button" id="delRem" name="delRem" value="Delete Reminder" /></td></tr>
    </table></td></tr>
    </table>
    
    
    </div>
    <div id="recordsNav"></div>
  </div>
</div>
<div id="systemOverlay"></div>
<div id="systemAlert">
...
<script type="text/javascript">calendar.set("remDate");</script>
<div id="availability">
