...
<script type="text/javascript" src="_js/dbpgajax.js"></script>
...
<div id="wrraper">
  <div id="systeminbox" class="tabDiv">
    ...
    <p>You can check all of your customers in here, save their details sotred in vCards to your Mail application</p>
    <p>or you can email them directly.</p>
    <p>&nbsp;</p>
    <div id="recordsNav"></div><div id="allDBRecords"></div>
  </div>
</div>
<div id="systemOverlay"></div>
<div id="systemAlert">
