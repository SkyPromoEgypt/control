...
<link href="_css/dtcalender.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="_js/reminders.js"></script>
...
<div id="wrraper">
  <div id="systeminbox" class="tabDiv">
    <h1>Reminders</h1>
    <p>The Calender show all of the reminders created by the syatems users. You can add, edit or delete reminiders here</p>
    <p>&nbsp;</p>
    <div id="monthView"></div>
    <div class="reminderBG" id="reminderView">
    ...
    <tr><td align="left" valign="top"><label for="remDate">Date</label></td><td><input type="text" id="remDate" name="remDate" /></td></tr>
    <tr><td align="left" valign="top"><label for="remText">Reminder</label></td><td><textarea id="remText" name="remText"></textarea></td></tr>
    <tr><td align="left" valign="top"></td><td><input type="button" id="addRem" name="addRem" value="Add Reminder" /><input type="button" id="delRem" name="delRem" value="Delete Reminder" /></td></tr>
    </table></td></tr>
    </table>
