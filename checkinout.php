...
<script type="text/javascript" src="_js/addnote.js"></script>
...
<div id="wrraper">
  ...
  <p>&nbsp;</p>
  <table width="700" id="chkinoutresults">
    <tr>
    ...
    <td>
    <?php
	$checkin = Room::get_checkin();
	if(count($checkin) == 0) {
		echo 'No Check In for Today';
	} else {
		foreach($checkin as $item) {
			echo 'HBS-PNG-' . $item->booking_reference . ' | ' . $item->room_number . ' | ' . $item->customer_name . '<br />';
		}
	}
    ...
    <tr><td colspan="2"><div id="recNotes">
      <p>Notes for the Recption Operator:    </p>
    </div></td></tr>
  </table>
  <p>&nbsp;</p>
  <form id="form1" name="form1" method="post" action="">
    ...
    <p>&nbsp;</p>
    <input type="button" id="submit" name="submit" value="Add Note" />
    <input type="button" id="printBtn" name="print" value="Print Report" />
  </form>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</div>
