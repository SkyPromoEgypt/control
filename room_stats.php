...
$total_count = count(Room::find_all());
?>
...
<link href="_css/mailcss.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="_js/roomStats.js"></script>
...
<body>
<input type="hidden" id="totalCount" value="<?php echo $total_count; ?>" />
<div id="liveSupport">
...
<div id="wrraper">
  <div id="systeminbox" class="tabDiv">
    <h1>Rooms Statistics</h1>
    <p>The following shows monthly bookings per month. To view a booking</p>
    <p>simply click on the booking reference. </p>
    <p>&nbsp;</p>
    <div id="allRoomsStats"></div>
    <div id="allRoomsStatsBooking"></div>
  </div>
</div>
<div id="systemOverlay"></div>
<div id="systemAlert">
  ...
  <form id="avDates">
    ...
    <table width="359" border="0">
      ...
      <tr>
        ...
        <input type="button" name="check" id="ucheckAvBtn" value="Check Vailability" />
        </td>
      </tr>
    </table>
  </form>
